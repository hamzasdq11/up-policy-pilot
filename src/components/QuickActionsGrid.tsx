          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-w-3xl mx-auto">
            {quickActions.map((action, i) => (
              <motion.button
                ...
                className="flex items-center gap-3 px-4 py-3.5 rounded-2xl border border-border bg-card hover:shadow-glass-lg transition-all text-left group"
              >
                <span className="text-lg w-8 h-8 flex items-center justify-center rounded-xl bg-secondary group-hover:scale-110 transition-transform">
                  {action.icon}
                </span>
